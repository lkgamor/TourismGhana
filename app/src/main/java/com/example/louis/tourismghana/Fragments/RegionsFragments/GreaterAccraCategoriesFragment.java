...
public class GreaterAccraCategoriesFragment extends Fragment{

    CardView goto_beaches, goto_monuments, goto_parks, goto_museums;
    private static String SITE_KEY = "OPTION";

    public GreaterAccraCategoriesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.greater_accra_categories_fragment, container, false);
        ...
        goto_beaches.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                gotoCategory.putExtra(SITE_KEY, "Greater_Accra-BEACHES");
        ...
        goto_monuments.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent gotoCategory = new Intent(getActivity(), SectionsActivity.class);
                gotoCategory.putExtra(SITE_KEY, "Greater_Accra-MONUMENTS");
                startActivity(gotoCategory);
        ...
        goto_parks.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent gotoCategory = new Intent(getActivity(), SectionsActivity.class);
                gotoCategory.putExtra(SITE_KEY, "Greater_Accra-PARKS");
                startActivity(gotoCategory);
        ...
        goto_museums.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent gotoCategory = new Intent(getActivity(), SectionsActivity.class);
                gotoCategory.putExtra(SITE_KEY, "Greater_Accra-MUSEUMS");
                startActivity(gotoCategory);
