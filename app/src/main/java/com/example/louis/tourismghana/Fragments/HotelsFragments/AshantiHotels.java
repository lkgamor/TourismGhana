 ...
 */
public class AshantiHotels extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_ashanti_hotels, container, false);
        ...
        hotelsAdapter.setOnItemClickListener(new HotelsAdapter.OnItemClickListener() {
            ...
            public void OnClickListener(View view, int position) {
                ...
                //Sending data of selected Item on recyclerView List to FinalGhanaInfo
    ...
    public void onStart() {
        ...
        hotelsList.clear();
        firestore.collection("/Hotels/Ashanti_Region/Ashanti_Hotels/").addSnapshotListener(getActivity(), new EventListener<QuerySnapshot>() {
            @Override
