 ...
 */
public class BrongHotels extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_brong_hotels, container, false);
    ...
    public void onStart() {
        ...
        hotelsList.clear();
        firestore.collection("/Hotels/Brong_Ahafo/Brong_Hotels/").addSnapshotListener(getActivity(), new EventListener<QuerySnapshot>() {
            @Override
