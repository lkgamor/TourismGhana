...
public class UpperEastCategoriesFragment extends Fragment {

    CardView goto_games, goto_monuments;
    private static String SITE_KEY = "OPTION";

    public UpperEastCategoriesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.upper_east_categories_fragment, container, false);
        ...
        goto_games.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                gotoCategory.putExtra(SITE_KEY, "Upper_East-GAMES");
        ...
        goto_monuments.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent gotoCategory = new Intent(getActivity(), SectionsActivity.class);
                gotoCategory.putExtra(SITE_KEY, "Upper_East-MONUMENTS");
                startActivity(gotoCategory);
