 ...
 */
public class UpperWestHotels extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_upper_west_hotels, container, false);
    ...
    public void onStart() {
        ...
        hotelsList.clear();
        firestore.collection("/Hotels/Upper_West/Upper_West_Hotels/").addSnapshotListener(getActivity(), new EventListener<QuerySnapshot>() {
            @Override
