...
public class NatureFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("Available Nature Reserves");
    ...
    public void loadSite()
    {
        ...
        siteList.clear();
        firestore.collection("/Tourist_Sites/" + REGION + "/Nature/").addSnapshotListener(getActivity(), new EventListener<QuerySnapshot>() {
            @Override
