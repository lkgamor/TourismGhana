 ...
 */
public class EasternHotels extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_eastern_hotels, container, false);
    ...
    public void onStart() {
        ...
        hotelsList.clear();
        firestore.collection("/Hotels/Eastern_Region/Eastern_Hotels/").addSnapshotListener(getActivity(), new EventListener<QuerySnapshot>() {
            @Override
