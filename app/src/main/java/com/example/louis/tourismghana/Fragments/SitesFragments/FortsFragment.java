...
public class FortsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_forts, container, false);

        getActivity().setTitle("Available Forts");
    ...
    public void loadSite()
    {
        ...
        siteList.clear();
        firestore.collection("/Tourist_Sites/" + REGION + "/Forts/").addSnapshotListener(getActivity(), new EventListener<QuerySnapshot>() {
            @Override
