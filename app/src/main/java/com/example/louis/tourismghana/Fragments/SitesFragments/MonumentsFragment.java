...
public class MonumentsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("Available Monuments");
    ...
    public void loadSite()
    {
        ...
        siteList.clear();
        firestore.collection("/Tourist_Sites/" + REGION + "/Monuments/").addSnapshotListener(getActivity(), new EventListener<QuerySnapshot>() {
            @Override
