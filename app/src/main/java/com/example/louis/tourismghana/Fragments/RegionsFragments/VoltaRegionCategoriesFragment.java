...
public class VoltaRegionCategoriesFragment extends Fragment{

    CardView goto_mountain, goto_waterfall, goto_nature, goto_monuments, goto_forts;
    private static String SITE_KEY = "OPTION";

    public VoltaRegionCategoriesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.volta_region_categories_fragment, container, false);
        ...
        goto_mountain = (CardView) view.findViewById(R.id.mountains);
        goto_waterfall = (CardView) view.findViewById(R.id.waterfalls);
        ...
        goto_mountain.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent gotoCategory = new Intent(getActivity(), SectionsActivity.class);
                gotoCategory.putExtra(SITE_KEY, "Volta_Region-MOUNTAINS");
                startActivity(gotoCategory);

            }
        });

        goto_waterfall.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent gotoCategory = new Intent(getActivity(), SectionsActivity.class);
                gotoCategory.putExtra(SITE_KEY, "Volta_Region-WATERFALLS");
                startActivity(gotoCategory);
        ...
        goto_nature.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent gotoCategory = new Intent(getActivity(), SectionsActivity.class);
                gotoCategory.putExtra(SITE_KEY, "Volta_Region-NATURES");
                startActivity(gotoCategory);
        ...
        goto_monuments.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent gotoCategory = new Intent(getActivity(), SectionsActivity.class);
                gotoCategory.putExtra(SITE_KEY, "Volta_Region-MONUMENTS");
                startActivity(gotoCategory);
        ...
        goto_forts.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent gotoCategory = new Intent(getActivity(), SectionsActivity.class);
                gotoCategory.putExtra(SITE_KEY, "Volta_Region-FORTS");
                startActivity(gotoCategory);
