...
// Inflate the layout for this fragment
        ...
        getActivity().setTitle("Wildlife Sites in this Region");
    ...
    public void loadSite()
    {
        ...
        siteList.clear();
        firestore.collection("/Tourist_Sites/" + REGION + "/Wildlife/").addSnapshotListener(getActivity(), new EventListener<QuerySnapshot>() {
            @Override
