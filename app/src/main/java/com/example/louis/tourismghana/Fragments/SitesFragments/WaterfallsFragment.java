...
// Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.fragment_waterfalls, container, false);

        getActivity().setTitle("Active Waterfalls");
    ...
    public void loadSite()
    {
        ...
        siteList.clear();
        firestore.collection("/Tourist_Sites/" + REGION + "/Waterfalls/").addSnapshotListener(getActivity(), new EventListener<QuerySnapshot>() {
            @Override
