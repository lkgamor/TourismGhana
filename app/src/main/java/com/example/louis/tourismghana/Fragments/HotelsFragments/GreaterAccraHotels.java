 ...
 */
public class GreaterAccraHotels extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_greater_accra_hotels, container, false);
    ...
    public void onStart() {
        ...
        hotelsList.clear();
        firestore.collection("/Hotels/Greater_Accra/Accra_Hotels/").addSnapshotListener(getActivity(), new EventListener<QuerySnapshot>() {
            @Override
