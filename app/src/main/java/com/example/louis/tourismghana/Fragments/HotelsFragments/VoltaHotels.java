 ...
 */
public class VoltaHotels extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_volta_hotels, container, false);
    ...
    public void onStart() {
        ...
        hotelsList.clear();
        firestore.collection("/Hotels/Volta_Region/Volta_Hotels/").addSnapshotListener(getActivity(), new EventListener<QuerySnapshot>() {
            @Override
